...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->Username = 'jefersonalfama@gmail.com'; // Usuário SMTP
        $mail->Password = 'bovy kgwj uyrf exou'; // Senha SMTP
        ...
        echo json_encode(['status' => 'error', 'message' => "Ocorreu um erro ao enviar o formulário: {$mail->ErrorInfo}"]);
    }
}
?>
